    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple3<Long, Double, Double>> result = noShed
                ...
                .apply(new JoinFunction<Tuple2<Long,List<Tuple2<String,Integer>>>,
                    ...
                    @Override
                    public Tuple3<Long, Double, Double> join(Tuple2<Long, List<Tuple2<String, Integer>>> t1,
                        ...
                        for (Tuple2<String, Integer> t : t2.f1)
                            t2Keys.add(t.f0);
                        return new Tuple3<Long, Double, Double>(t1.f0, SimUtils.RankedBiasedDistance(t1Keys, t2Keys, 0.8),
